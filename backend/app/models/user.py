...
class User(Base):
    ...
    password_hash = Column(String(255), nullable=True)  # Optional for Keycloak users
    keycloak_id = Column(String(255), unique=True, nullable=True, index=True)  # Keycloak user ID
